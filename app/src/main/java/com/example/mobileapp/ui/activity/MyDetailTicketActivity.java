...
public class MyDetailTicketActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detail_my_tickets);
        Toolbar toolbar = findViewById(R.id.toolbarMyTicket);
